...
class __TreeCollection {
  public:
	 ...
	 */
	virtual int get_counts_of_trees_by_boro(const string& species_name, boro tree_count[5]) = 0;
	 ...
	 */
	virtual list<string> get_matching_species(const string& species_name) const = 0;
	 ...
	 */
	virtual list<string> get_all_near(double latitude, double longitude, double distance) const = 0;
};
