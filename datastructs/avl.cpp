...
class AvlTree {
  ...
  private:
	...
	// PERSONAL implementation functions
	ostream& print(ostream& os, AvlNode<Comparable>*& root);
};
...
template <class Comparable>
ostream& AvlTree<Comparable>::print(ostream& os, AvlNode<Comparable>*& tree_root) {
	print(os, tree_root->left);
	os << root->element;
	print(os, tree_root->right);

	return os;
}

template <class Comparable>
ostream& AvlTree<Comparable>::display(ostream& os) {
	return print(os, root);
}
